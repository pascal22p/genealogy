...
CREATE TABLE `genea_events_details` (
                                        ...
                                        CONSTRAINT `genea_events_details_ibfk_1` FOREIGN KEY (`base`) REFERENCES `genea_infos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `genea_familles` (
                                  ...
                                  `base` mediumint(8) DEFAULT NULL COMMENT 'Champ Ã  virer',
...
CREATE TABLE `genea_individuals` (
                                     ...
                                     `base` mediumint(8) NOT NULL,
                                     `indi_nom` char(200) NOT NULL DEFAULT '',
                                     `indi_prenom` char(200) NOT NULL DEFAULT '',
                                     ...
                                     KEY `base` (`base`),
                                     KEY `base_indi_nom_indi_id` (`base`,`indi_nom`,`indi_id`),
...
CREATE TABLE `genea_refn` (
                              ...
                              PRIMARY KEY (`refn_id`),
                              KEY `base` (`base`),
                              CONSTRAINT `1` FOREIGN KEY (`base`) REFERENCES `genea_infos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `genea_sour_citations` (
                                        ...
                                        `sour_records_id` mediumint(8) unsigned NOT NULL,
                                        ...
                                        KEY `base` (`base`),
                                        CONSTRAINT `1` FOREIGN KEY (`sour_records_id`) REFERENCES `genea_sour_records` (`sour_records_id`),
                                        CONSTRAINT `2` FOREIGN KEY (`base`) REFERENCES `genea_infos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `genea_sour_records` (
                                      ...
                                      KEY `base` (`base`),
                                      KEY `repo_id` (`repo_id`),
                                      CONSTRAINT `1` FOREIGN KEY (`repo_id`) REFERENCES `genea_repository` (`repo_id`),
                                      CONSTRAINT `2` FOREIGN KEY (`base`) REFERENCES `genea_infos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `rel_familles_sources` (
                                        ...
                                        KEY `sources_id` (`sour_citations_id`),
                                        CONSTRAINT `rel_familles_sources_ibfk_1` FOREIGN KEY (`familles_id`) REFERENCES `genea_familles` (`familles_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                        CONSTRAINT `rel_familles_sources_ibfk_2` FOREIGN KEY (`sour_citations_id`) REFERENCES `genea_sour_citations` (`sour_citations_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `rel_multimedia_notes` (
                                        ...
                                        KEY `media_id` (`media_id`),
                                        CONSTRAINT `rel_multimedia_notes_ibfk_1` FOREIGN KEY (`notes_id`) REFERENCES `genea_notes` (`notes_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                        CONSTRAINT `rel_multimedia_notes_ibfk_2` FOREIGN KEY (`media_id`) REFERENCES `genea_multimedia` (`media_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `rel_sour_citations_notes` (
                                            ...
                                            CONSTRAINT `rel_sour_citations_notes_ibfk_1` FOREIGN KEY (`notes_id`) REFERENCES `genea_notes` (`notes_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
                                            CONSTRAINT `rel_sour_citations_notes_ibfk_2` FOREIGN KEY (`sour_citations_id`) REFERENCES `genea_sour_citations` (`sour_citations_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Association d''un objet multimedia Ã  une source';
