...
import play.api.data.Forms.{text, nonEmptyText, of}
...
object SourRecordForm {
  ...
  def unapply(u: SourRecordForm): Option[(String, String, String, String, String, String, String, String, Int, SourCitationType.SourCitationType)] = Some((u.auth, u.title, u.abbr, u.publ, u.agnc, u.rin, u.repoCaln, u.repoMedi, u.parentId, u.parentType))
